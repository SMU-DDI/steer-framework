// =================================================================================================
//! @file __testnameus___mt.c
//! @author Gary Woodcock (gary@anametric.com)
//! @brief This file implements the multi-threaded version of the NIST STS __testnamefull__ test 
...
typedef struct tnist___testname__testdata
{
...
tNIST___testnamecaps__TestData;

typedef struct tnist___testname__thread
{
    pthread_t                           threadId;
    uint64_t                            testId;
    tNIST___testnamecaps__TestData    testData;
}
tNIST___testnamecaps__Thread;
...
typedef struct tnist___testname__privatedata
{
    ...
    tNIST___testnamecaps__Thread  thread[];
}
                      ...
                      tNIST___testnamecaps__TestData* testData)
{
    ...
    if (result == STEER_RESULT_SUCCESS)
    {
        ...
        memset((void*)calculationStr, 0, STEER_STRING_MAX_LENGTH);
        sprintf(calculationStr, STEER_DEFAULT_FLOATING_POINT_STRING_FORMAT, 
                STEER_DEFAULT_FLOATING_POINT_PRECISION, testData->__testnameskipcap__);
        result = STEER_AddCalculationToTest(report, 0, testId,
...
// =================================================================================================
int32_t GetNextAvailableThread (tNIST___testnamecaps__PrivateData* privateData)
{
    int32_t index = -1;
    uint_fast32_t i = 0;
...
//  ThreadsReady
// =================================================================================================
bool ThreadsReady (tNIST___testnamecaps__PrivateData* privateData)
{
    bool ready = true;
    uint_fast32_t i = 0;
...
{
    tNIST___testnamecaps__TestData* testData = (tNIST___testnamecaps__TestData*)ptr;
	int_fast32_t i = 0;
    int_fast32_t j = 0;
    int32_t k = 0;
    int32_t r = 0;
    ...
    testData->__testnameskipcap__ = 0.0;
    ...
    if (testData->result == STEER_RESULT_SUCCESS)
    {
        testData->__testnameskipcap__ = entropyDistribution[0] - entropyDistribution[1];
        testData->chiSquared = 2.0 * seqLength * (gCommonData.log2pt0 - testData->__testnameskipcap__);
        testData->probabilityValue = 
                  ...
                  uint64_t* bufferSizeInBytes)
{
    ...
    *bufferSizeInBytes = 0;
    ...
    if (result == STEER_RESULT_SUCCESS)
    {
        ...
        result = STEER_AllocateMemory(sizeof(tNIST___testnamecaps__PrivateData) +
                                      (threadCount * sizeof(tNIST___testnamecaps__Thread)),
                                      (void**)&privData);
                     ...
                     uint64_t numOnes)
{
    ...
    {
        // Queue it up
        memset((void*)&(privData->thread[threadIndex].testData), 0, sizeof(tNIST___testnamecaps__TestData));
...
{
    int32_t result = STEER_RESULT_SUCCESS;
    tNIST___testnamecaps__PrivateData* privData = (tNIST___testnamecaps__PrivateData*)(*privateData);
