...
void __ogg_fdrffti(int32_t n, double *wsave, int32_t *ifac)
void __ogg_fdrfftf(int32_t n, double *r, double *wsave, int32_t *ifac)
void __ogg_fdrfftb(int32_t n, double *r, double *wsave, int32_t *ifac)
...
void __ogg_fdcosqi(int32_t n, double *wsave, int32_t *ifac)
void __ogg_fdcosqf(int32_t n, double *x, double *wsave, int32_t *ifac)
void __ogg_fdcosqb(int32_t n, double *x, double *wsave, int32_t *ifac)
*/
...
static void drfti1(int32_t n, double *wa, int32_t *ifac)
{
	static int32_t	ntryh[4] = { 4,2,3,5 };
	static double	tpi = 6.28318530717958647692528676655900577;
	double			arg, argh, argld, fi;
	int32_t			ntry=0,i,j=-1;
	int32_t			k1, l1, l2, ib;
	int32_t			ld, ii, ip, is, nq, nr;
	int32_t			ido, ipm, nfm1;
	int32_t			nl=n;
	int32_t			nf=0;
...
STIN void dradf2(int32_t ido, int32_t l1, double *cc, double *ch, double *wa1)
{
	int32_t	i , k;
	double	ti2 , tr2;
...
STIN void dradf4(int32_t ido, int32_t l1, double *cc, double *ch, double *wa1,
				 double *wa2, double *wa3)
{
	static double	hsqt2 = .70710678118654752440084436210485;
	int32_t			i, k, t0, t1, t2, t3, t4, t5, t6;
...
STIN void dradfg(int32_t ido, int32_t ip, int32_t l1, int32_t idl1, double *cc, double *c1,
				 double *c2, double *ch, double *ch2, double *wa)
{
	static double	tpi = 6.28318530717958647692528676655900577;
	int32_t			idij, ipph, i, j, k, l, ic, ik, is;
	int32_t			t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10;
...
STIN void drftf1(int32_t n, double *c, double *ch, double *wa, int32_t *ifac)
{
	int32_t	i, k1, l1, l2;
	int32_t	na, kh, nf;
	int32_t	ip, iw, ido, idl1, ix2, ix3;
...
STIN void dcsqf1(int32_t n, double *x, double *w, double *xh, int32_t *ifac)
{
	int32_t	modn, i, k, kc;
	int32_t	np2, ns2;
	double	xim1;
...
STIN void dradb2(int32_t ido, int32_t l1, double *cc, double *ch, double *wa1)
{
	int32_t	i, k, t0, t1, t2, t3, t4, t5, t6;
	double	ti2, tr2;
...
STIN void dradb3(int32_t ido, int32_t l1, double *cc, double *ch, double *wa1, double *wa2)
{
	static double	taur = -.5;
	static double	taui = .86602540378443864676372317075293618;
	int32_t			i, k, t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10;
...
STIN void dradb4(int32_t ido, int32_t l1, double *cc, double *ch, double *wa1,
				 double *wa2, double *wa3)
{
	static double	sqrt2=1.4142135623730950488016887242097;
	int32_t			i, k, t0, t1, t2, t3, t4, t5, t6, t7, t8;
	double			ci2, ci3, ci4, cr2, cr3, cr4;
	double			ti1, ti2, ti3, ti4, tr1, tr2, tr3, tr4;
...
STIN void dradbg(int32_t ido, int32_t ip, int32_t l1, int32_t idl1, double *cc, double *c1,
				 double *c2, double *ch, double *ch2, double *wa)
{
	static double	tpi=6.28318530717958647692528676655900577;
	int32_t			idij, ipph, i, j, k, l, ik, is;
	int32_t			t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12;
	double			dc2, ai1, ai2, ar1,ar2, ds2;
	int32_t			nbd;
	double			dcp, arg, dsp, ar1h, ar2h;
	int32_t			ipp2;
...
STIN void drftb1(int32_t n, double *c, double *ch, double *wa, int32_t *ifac)
{
	int32_t	i, k1, l1, l2;
	int32_t	na;
	int32_t	nf, ip, iw, ix2, ix3, ido, idl1;
...
STIN void dcsqb1(int32_t n, double *x, double *w, double *xh, int32_t *ifac)
{
	int32_t	modn, i, k, kc;
	int32_t	np2, ns2;
	double	xim1;
