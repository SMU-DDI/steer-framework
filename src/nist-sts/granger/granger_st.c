...
//! @file granger_st.c
//! @author %author% (%email%)
//! @brief This file implements the single-threaded version of the NIST STS granger test 
                 ...
                 bool* passed)
{
    ...
    *passed = false;
    ...
    if (result == STEER_RESULT_SUCCESS)
    {
        privateData->granger = entropyDistribution[0] - entropyDistribution[1];
        privateData->chiSquared = 2.0 * seqLength * (gCommonData.log2pt0 - privateData->granger);
