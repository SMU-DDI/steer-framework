// =================================================================================================
//! @file approximate_entropy_st.c
//! @author Gary Woodcock (gary@anametric.com)
//! @brief This file implements the single-threaded version of the NIST STS approximate entropy test 
...
//  RunTest
// =================================================================================================
int32_t RunTest (tNIST_ApproximateEntropyPrivateData* privateData,
                 ...
                 bool* passed)
{
    ...
    privateData->approximateEntropy = 0.0;
    ...
    *passed = false;
    ...
    if (result == STEER_RESULT_SUCCESS)
    {
        privateData->approximateEntropy = entropyDistribution[0] - entropyDistribution[1];
        privateData->chiSquared = 2.0 * seqLength * (gCommonData.log2pt0 - privateData->approximateEntropy);
                  ...
                  uint64_t* bufferSizeInBytes)
{
    ...
    *bufferSizeInBytes = 0;
    ...
    result = STEER_AllocateMemory(sizeof(tNIST_ApproximateEntropyPrivateData), (void**)&privData);
                     ...
                     uint64_t numOnes)
{
    ...
    if (result == STEER_RESULT_SUCCESS)
    {
        ...
        memset((void*)calculationStr, 0, STEER_STRING_MAX_LENGTH);
        sprintf(calculationStr, STEER_DEFAULT_FLOATING_POINT_STRING_FORMAT, 
                STEER_DEFAULT_FLOATING_POINT_PRECISION, privData->approximateEntropy);
        result = STEER_AddCalculationToTest(privData->report, 0, testId,
